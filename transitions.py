...
def draw(self, origin: Deck, destination: Deck, amount: int = 1, visibility: int = Card.FACE_UP) -> bool:
...
def equip_card_to(self, origin: Deck, index: int, destination: Deck, target_index: int, visibility: int = Card.FACE_UP) -> None:
...
def add_target(self, origin: Deck, index: int, destination: Deck, target_index: int) -> None:
